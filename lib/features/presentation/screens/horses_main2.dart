...
class HorsesMain2 extends StatefulWidget {
  const HorsesMain2({super.key});

  @override
  State<HorsesMain2> createState() => _HorsesMain2State();
}

class _HorsesMain2State extends State<HorsesMain2> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                child:
                    Image.asset('assets/images/horse2.png', fit: BoxFit.cover),
              ),
              SizedBox(height: 24),
