...
class SheepFert2 extends StatefulWidget {
  const SheepFert2({super.key});

  @override
  State<SheepFert2> createState() => _SheepFert2State();
}

class _SheepFert2State extends State<SheepFert2> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                child:
                    Image.asset('assets/images/shfert2.png', fit: BoxFit.cover),
              ),
              SizedBox(height: 24),
