...
class HensDesease2 extends StatefulWidget {
  const HensDesease2({super.key});

  @override
  State<HensDesease2> createState() => _HensDesease2State();
}

class _HensDesease2State extends State<HensDesease2> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                child:
                    Image.asset('assets/images/hensdes1.png', fit: BoxFit.cover),
              ),
              SizedBox(height: 24),
